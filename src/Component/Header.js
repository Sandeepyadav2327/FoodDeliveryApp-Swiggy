...
export default function Header(){
    ...
    return(
        <header className="bg-[#ff5200] font-serif">
            <div className="flex justify-between mx-30 py-8">
                ...
                <div className="font-serif text-white text-base bont-bold flex gap-20 items-center">
                    <a target="_blank" href="https://www.swiggy.com/corporate/">Swiggy Corporate</a>
                    <a target="_blank" href="https://partner.swiggy.com/login#/swiggy">Partner with us</a>
                    <a className="border-2 border-white rounded py-3 px-4" target="_blank" href="https://www.swiggy.com/corporate/">Get the App</a>
                    <a className="border-2 border-white bg-black rounded py-3 px-4" target="_blank" href="https://www.swiggy.com/corporate/">Sign in</a>
                </div>
            </div>
            ...
            <div className="pt-16 pb-8 relative">
                ...
                <div className="text-5xl text-white font-bold max-w-[60%] flex mx-auto text-center">
                    Order Food and Groceries. Discover Best restaurants. Swiggy it!
                </div>
                <div className="max-w-[70%] container mx-auto flex gap-10 mt-10">
                    <input className="bg-white w-[30%] text-xl rounded ml-25" placeholder="Enter your Delivery location"></input>
                    <input className="bg-white w-[40%] text-xl rounded ml-25" placeholder="Search for restaurants and items for more"></input>
                </div>
            </div>
